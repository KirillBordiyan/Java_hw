...
public class ComplexController {
    public void start(){
        ...
        while (true) {
            System.out.println("Формат ввода комплексных чисел: a (+/-) bi (перед и после знака - 1 пробел,i слитно с b)\n"
                                +"например: 3 - 2i\n"
                                +"если предполагается b = 1, тогда перед i необходимо написать эту 1, т.е. a (+/-) 1i"
            );
            System.out.println("1 - сложить\n2 - умножить\n3 - поделить");
            String move = getInput();

            System.out.println("Вводить только пару натуральных ИЛИ комплексных чисел\n"
                                +"чтобы произвести операцию с натуральным и комплексным числами, необходимо ввести натуральное как комплексное\n"
                                +"в виде a (+/-) 0i, например вместо 5 будет 5 + 0i"
            );
